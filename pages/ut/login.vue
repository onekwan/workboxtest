...
export default {
	 ...
	 created() {
		  ...
		  try{
				let site = JSON.parse(window.localStorage.getItem(this.keyName));
	 ...
	 methods: {
		  ...
		  async tryToLogIn() {
				...
				if(vm.site_id === ''){
					 tool_app.dialog_alert('사업장을 선택해주세요.')
					 return false;
				}
				...
				if (this.$v.$invalid) {
					 ...
					 try{
                        ...
                        window.localStorage.setItem('loginType', 'tenant');
                    ...
                    vm.tryingToLogIn = false;
                    tool_app.dialog_alert('로그인에 실패하였습니다.<br/>'+tool_app.getErrorMsg(e))
        ...
        setSite(value,item){
              ...
              window.localStorage.setItem(this.keyName, JSON.stringify(item));
		  }
	 }
};
</script>
								...
								<div class="card">
                                  ...
                                  <div class="col-lg-12">
                                        <div class="text-center">
                                              <h1 class="font-size-24 justify-content-center align-content-center" style="height: 50px">입주사 로그인</h1>
                                        </div>
                                  </div>
										  <div class="p-2 mt-4">

												  <div class="mb-3">
														  <label class="mb-2">사업장</label>
                                            <custom-search-select v-model="site_id" :type="'login'"
                                                                  @input="setSite"
                                                                  :init-data="site"
...
<!--												<div class="mt-3 text-end">-->
<!--													 <nuxt-link to="/account/register_nott">일반 회원 가입 하기</nuxt-link>-->
<!--												</div>-->
