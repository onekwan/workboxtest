      ...
      <div class="d-inline">
            <b-modal ref="modal" id="modal-standard" :title="'정기권 상품 ' + (mode === 'edit' ? '수정' : '등록')"
                  ...
                  <b-container>
                        ...
                        <custom-search-select v-model="api_data.passFormId" 
                            :init-data="this.pageData && this.pageData.passForm ? this.pageData.passForm : null"
                            :type="'passform'"  @input="loadPassForm" :disabled="mode==='edit'"
                            :is-invalid="api_submitted && $v.api_data.passFormId.$error"
