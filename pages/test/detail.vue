	 ...
	 <PageLayout :title="title" :page-loading="pageLoading">
			 <b-row>
					 <b-col cols="8">
                      ...
                      <ModalPassesForm ref="ref_ModalPassesForm" :page-data="detailData" mode="edit" :callback="refreshAfterChange"/>
		  ...
		  <b-col cols="12">
				<div class="card-body">
					 <dl class="row detail_page_striped">
						  ...
						  <dd class="col-9">
                          <link-page type="machineGroupDetail" :linked="detailData.enterMachineGroup"></link-page>
						  </dd>
