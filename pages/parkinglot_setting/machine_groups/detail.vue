...
export default {
  ...
  data() {
    return {
      ...
      apiPath: '/api/v1/machine-groups/',
      deleteMsgTitle: '설비 그룹'
    };
  },
  ...
  <PageLayout :title="title" :page-loading="pageLoading">
    <b-row>
      <b-col cols="8">
        ...
        <ModalMachineGroups ref="ref_ModalMachines" :page-data="detailData" mode="edit"
    ...
    <b-col cols="12">
      <div class="card-body">
        <dl class="row detail_page_striped">
          ...
          <dt class="col-sm-3">설비목록</dt>
          <dd class="col-9">
            <link-page :type="'machineDetail'" :linked="detailData.machineGroups" />
          </dd>
